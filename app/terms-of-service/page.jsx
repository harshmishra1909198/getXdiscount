...
export const metadata = {
  title: "Terms of Service | Discountifier App",
  description: "Terms of Service page for Discountifier App with merchant-facing app terms.",
};
      ...
      <Container>
        <Card className="bg-gradient-to-br from-white to-slate-50/70">
          ...
          <p className="mt-4 max-w-3xl text-base leading-8 text-slate-600">
            By installing or using Discountifier App, the merchant agrees to these Terms of
        ...
        <Card>
          ...
          <p className="mt-4 text-base leading-8 text-slate-600">
            The merchant is responsible for ensuring that all use of Discountifier App complies
        ...
        <Card>
          ...
          />
          <p className="mt-4 text-base leading-8 text-slate-600">
            Merchants may use Discountifier App to configure discounts, launch campaigns, and
        ...
        <Card>
          ...
          <p className="mt-4 text-base leading-8 text-slate-600">
            To the fullest extent permitted by law, Discountifier App is provided on an as-is
        ...
        <Card>
          ...
          <p className="mt-4 text-base leading-8 text-slate-600">
            ...
            stated. Continued use of Discountifier App after an update means the merchant
